              ...
              {errors.username && (
                <div className='input-error-message-container'>
                  ...
                  <p className='input-error-message'>
                    Username length must be from 3 to 20 symbols
                  </p>
                </div>
              )}
            </label>
            ...
            <label>
              ...
              {errors.password && (
                <div className='input-error-message-container'>
                  <div className='warning-input'></div>
                  <p className='input-error-message'>
                    Password length must be from 6 to 40 symbols
                  </p>
                </div>
              )}
            </label>
          ...
          <div className='lisence-agreement'>
            <label>
              <div className='checkbox-container'>
                ...
                />
                <div
                  className='checkbox-clone-non-checked'
                  style={nonCheckStatus}
                ></div>
            ...
            {signUpError && (
              <div className='sign-up-error-container'>
                <p className='sign-up-error-message'>
                  Error! Try to refresh page and create account again!
                </p>
              </div>
            )}
