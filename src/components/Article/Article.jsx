...
import { getArticle, getCurrentUser, deleteArticle } from '../../api/api';
...
const Article = ({ token, loggedIn }) => {
  ...
  useEffect(() => {
    getArticle(token, slug, setArticle);
  }, [slug, token]);

  useEffect(() => {
    getCurrentUser(token, loggedIn, setCurrentUser);
  }, [loggedIn, token]);
  ...
  const yesButtonHandler = () => {
    deleteArticle(token, slug, setIsArticleDeleted, setIsButtonClicked);
  };
                  ...
                  {isDeleteButtonClicked && (
                    <div className="delete-article-modal-window">
                      ...
                      <div className="modal-window-footer">
                        ...
                        <button
                          type="button"
                          className="modal-window-yes-button"
